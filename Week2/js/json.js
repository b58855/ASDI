...
var json = {
	...
	'task2': {
		...
		'assigned': ['Assigned', 'Anthony Weaver'],
	...
	'task3': {
		...
		'assigned': ['Assigned', 'Slartybartfast'],
	...
	'task4': {
		...
		'assigned': ['Assigned', 'Luke Skywalker'],
	...
	'task5': {
		...
		'assigned': ['Assigned', 'Sir Lancelot'],
		'startDate': ['Start Date', '2013-03-19'],
	...
	'task6': {
		...
		'assigned': ['Assigned', 'Patrick Star'],
	...
	'task9': {
		'category': ['Category', 'Sound'],
		'task': ['Task', 'UI Sounds'],
		'assigned': ['Assigned', 'Frodo Baggins'],
		'startDate': ['Start Date', '2013-04-01'],
		'endDate': ['End Date', '2013-04-28'],
		'hours': ['Hours', '50'],
